...
<nav class="lp-nav" id="lpNav">
  <div class="lp-nav-inner">
    ...
    <div class="lp-links">
      <a href="<?= BASE_URL ?>/eclandingpage.php"    class="lp-link">Home</a>
      <a href="<?= BASE_URL ?>/about.php"            class="lp-link active">About</a>
      <a href="<?= BASE_URL ?>/trainings-public.php" class="lp-link">Trainings</a>
      <a href="<?= BASE_URL ?>/contact.php"          class="lp-link">Contact</a>
    </div>
    <div class="lp-nav-actions">
      <a href="<?= BASE_URL ?>/login.php"       class="lp-btn-login">&#10148; Log In</a>
      <a href="<?= BASE_URL ?>/choose-role.php" class="lp-btn-signup">&#43; Sign Up</a>
    </div>
  </div>
</nav>
...
<section style="padding:80px 0;background:#fff">
  <div style="max-width:1100px;margin:0 auto;padding:0 28px;display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center">
    ...
    <div class="feature-row">
      <?php foreach ([
        ['&#128218;','Training Management','Create, schedule, and monitor extension training programs across all CIT specializations.','rgba(26,86,219,.08)','#1A56DB'],
        ['&#128101;','Beneficiary Tracking','Register and track participants, attendance, and post-training outcomes in one place.','rgba(16,185,129,.08)','#10B981'],
        ['&#9989;','Evaluation & Feedback','Collect and analyze participant evaluations to continuously improve training quality.','rgba(245,158,11,.08)','#F59E0B'],
        ['&#128200;','Skills Utilization','Track how beneficiaries apply their skills — personal use, income generation, and employment.','rgba(99,102,241,.08)','#6366F1'],
        ['&#128196;','Automated Reports','Generate CHED-compliant accomplishment reports and training summaries with ease.','rgba(239,68,68,.08)','#EF4444'],
  ...
  <div style="max-width:1100px;margin:0 auto;padding:0 28px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:start">
      ...
      <div class="card-grid" style="grid-template-columns:1fr 1fr">
        <?php foreach ([
          ['🎓','Technical & Vocational Education','Offering 8 specialization areas aligned with industry needs.'],
          ['🛠️','Hands-On Training','Combining theory with practical skills for workforce readiness.'],
        ...
        <div class="info-card">
          <div style="font-size:28px;margin-bottom:10px"><?= $em ?></div>
...
<section style="padding:80px 0;background:#fff">
  <div style="max-width:1100px;margin:0 auto;padding:0 28px">
    ...
    <div class="card-grid">
      <?php foreach ([
        ['🤝','LGU & Partner Collaboration','Conducted in partnership with local government units, NGOs, and community stakeholders for broader community reach.'],
        ['👥','Inclusive Beneficiary Coverage','Reaching out-of-school youth, displaced workers, solo parents, farmers, retirees, and other qualified community members.'],
        ['📋','Structured Implementation','From needs assessment and proposal preparation to Project Leader assignment, approval, and post-training evaluation — managed end to end.'],
        ['🌱','Community Development','Actively contributing to inclusive growth and sustainable development through CIT extension service programs.'],
        ['🎓','Skills & Livelihood','Empowering participants to apply their learning for personal development, employment, or livelihood generation.'],
        ['📊','CHED Compliance','All programs are documented and reported in compliance with CHED extension service requirements and standards.'],
      ] as [$em,$title,$desc]): ?>
      <div class="info-card">
        <div style="font-size:32px;margin-bottom:12px"><?= $em ?></div>
...
<footer class="lp-footer">
  <div class="lp-container">
    <div class="lp-footer-grid">
      <div>
        <div class="lp-footer-logo">
          <div class="lp-footer-logo-box"><img src="<?= BASE_URL ?>/imgs/logofinalpt.png" alt="CIT" onerror="this.style.display='none'"/></div>
        ...
        <div class="lp-footer-contact">
          <div class="lp-footer-ci">&#128205; SLSU Main Campus, Lucban, Quezon</div>
      ...
      <div>
        ...
        <div class="lp-footer-links">
          ...
          <a href="<?= BASE_URL ?>/about.php"            class="lp-footer-link">About</a>
      ...
      <div>
        ...
        <div class="lp-footer-links">
          ...
          <a href="<?= BASE_URL ?>/choose-role.php" class="lp-footer-link">Sign Up</a>
    ...
    <div class="lp-footer-bottom">
      <div class="lp-footer-copy">© <?= date('Y') ?> PAThrive – SLSU College of Industrial Technology. All rights reserved.</div>
