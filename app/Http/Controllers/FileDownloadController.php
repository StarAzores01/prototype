...
class FileDownloadController extends Controller
{
    ...
    /** An Activity's cover/display picture — same "any of the 4 roles" floor as training_docs/impact_assessments. */
    public function activityCover(Training $training)
    {
        $this->authorizeAnyRole();

        abort_if(! $training->cover_image, 404);
