...
class SkillsController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($editTrainingId) {
            $training = Training::where('id', $editTrainingId)->where('trainer_id', $trainerId)->first();
            if ($training) {
    ...
    {
        $skills = SkillsUtilization::whereHas('training', fn ($t) => $t->where('trainer_id', $trainerId))
        ...
        $trainingSummary = Training::where('trainer_id', $trainerId)
