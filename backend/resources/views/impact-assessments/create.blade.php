                    ...
                    <div>
                        ...
                        @if ($availableBeneficiaries->isEmpty())
                            <p class="text-sm text-gray-500 mt-2">
                                {{ __('Every participant already has an impact assessment requested, or there are no participants yet.') }}
                            </p>
                        @endif
                    </div>

                    <div class="flex items-center justify-end mt-6 gap-4">
                        <a href="{{ route($routePrefix.'.impact-assessments.index', $training) }}" class="text-sm text-gray-600 hover:text-gray-900">
                            {{ __('Cancel') }}
                        </a>
