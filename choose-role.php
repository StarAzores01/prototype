...
<div class="page">
  ...
  <div class="cards">
    ...
    <a href="<?= BASE_URL ?>/trainer-signup.php" class="card">
      <div class="card-icon" style="background:#D1FAE5;color:#10B981">&#128218;</div>
      <div class="card-label">Project Leader</div>
      <span class="card-btn" style="background:#10B981">Sign Up &#8594;</span>
    </a>

    <a href="<?= BASE_URL ?>/beneficiary-signup.php" class="card">
      <div class="card-icon" style="background:#FEF3C7;color:#F59E0B">&#127891;</div>
      <div class="card-label">Participant</div>
      <span class="card-btn" style="background:#F59E0B">Sign Up &#8594;</span>
    </a>

    <a href="<?= BASE_URL ?>/evaluator-signup.php" class="card">
      <div class="card-icon" style="background:#EDE9FE;color:#8B5CF6">&#128203;</div>
      <div class="card-label">Evaluator</div>
      <span class="card-btn" style="background:#8B5CF6">Sign Up &#8594;</span>
    </a>
  ...
  <a href="<?= BASE_URL ?>/eclandingpage.php" class="back-btn">&#8592; Back to Home</a>
