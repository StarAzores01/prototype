...
<div class="home-grid" style="margin-bottom:24px">
  <div class="training-card">
    <div class="training-card-body" style="display:flex;flex-direction:column;height:100%;box-sizing:border-box">
      ...
      <div class="training-card-desc" style="flex:1">Answer training evaluations sent to you by the Extension Coordinator or Project Leader.</div>
      <div class="training-card-footer" style="justify-content:flex-end">
        <a href="{{ route('beneficiary.evaluations') }}" class="btn btn-sm btn-primary">Open <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
  </div>
  <div class="training-card">
    <div class="training-card-body" style="display:flex;flex-direction:column;height:100%;box-sizing:border-box">
      ...
      <div class="training-card-desc" style="flex:1">Answer impact assessment surveys about how training has affected you.</div>
      <div class="training-card-footer" style="justify-content:flex-end">
        <a href="{{ route('beneficiary.impact_assessment') }}" class="btn btn-sm btn-primary">Open <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
  </div>
  <div class="training-card">
    <div class="training-card-body" style="display:flex;flex-direction:column;height:100%;box-sizing:border-box">
      ...
      <div class="training-card-desc" style="flex:1">Tell us how you've applied the skills you learned.</div>
      <div class="training-card-footer" style="justify-content:flex-end">
        <a href="{{ route('beneficiary.skills') }}" class="btn btn-sm btn-primary">Open <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
  </div>
</div>
...
<div class="card">
  <div class="card-header">
    <div><div class="card-title"><i class="fas fa-clock-rotate-left"></i> Recent Surveys</div></div>
  </div>
  <div class="table-wrap">
    <table>
      <thead><tr><th>Survey</th><th>Type</th><th>Activity</th><th>Sent</th><th>Status</th></tr></thead>
      <tbody>
      @forelse($recentSurveys as $f)
        <tr>
          <td><strong>{{ $f->title }}</strong></td>
          <td style="font-size:12px;color:var(--gray-600)">{{ $f->surveyType }}</td>
      ...
      @empty
        <tr><td colspan="5" style="text-align:center;padding:24px;color:var(--gray-400)">No surveys sent to you yet.</td></tr>
      @endforelse
      </tbody>
    </table>
  </div>
