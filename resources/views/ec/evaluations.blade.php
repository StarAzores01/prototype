  ...
  <div class="card-body">
    <form method="POST" action="{{ route('ec.evaluations.store') }}" id="formBuilder">
      ...
      <div class="form-group" style="margin-bottom:20px">
        ...
        <input type="text" name="form_title" class="form-control" value="{{ $editForm->title ?? 'Training Evaluation Form' }}" required/>
      </div>
...
<div class="card">
  ...
  <div class="table-wrap">
    <table>
      ...
      @empty
        <tr><td colspan="9" style="text-align:center;padding:40px;color:var(--gray-400)">No training data available.</td></tr>
      @endforelse
      </tbody>
    </table>
  </div>
