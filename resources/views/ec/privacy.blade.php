...
<div class="page-header">
  <div class="page-header-left">
    <div class="breadcrumb">PAThrive <i class="fas fa-chevron-right"></i> <span>Privacy Policy</span></div>
...
<div class="card" style="max-width:860px">
  <div class="card-body" style="line-height:1.9;font-size:14px;color:var(--gray-700)">
    ...
    <div style="margin-bottom:24px">
      <div style="font-size:16px;font-weight:700;color:var(--text-heading);margin-bottom:8px">1. Information We Collect</div>
      ...
      <ul style="margin-top:8px;padding-left:20px;display:flex;flex-direction:column;gap:6px">
        ...
        <li>Activity/program data (title, schedule, area, status)</li>
    ...
    <div style="margin-bottom:24px">
      <div style="font-size:16px;font-weight:700;color:var(--text-heading);margin-bottom:8px">4. Data Retention</div>
      <p>Activity records and participant data are retained for the duration required by CHED regulations and SLSU institutional policies. Users may request data correction through the Extension Office.</p>
    </div>

    <div style="margin-bottom:24px">
      <div style="font-size:16px;font-weight:700;color:var(--text-heading);margin-bottom:8px">5. Cookies &amp; Sessions</div>
      <p>PAThrive uses PHP sessions to maintain your login state. No third-party tracking cookies are used.</p>
    </div>

    <div style="margin-bottom:24px">
      <div style="font-size:16px;font-weight:700;color:var(--text-heading);margin-bottom:8px">6. Your Rights</div>
