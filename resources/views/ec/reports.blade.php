...
<div class="rpt-section">
  ...
  <div class="chart-row">
    <div class="chart-card">
      <div class="chart-card-title"><i class="fas fa-chart-column"></i> Trainings by Status</div>
      <canvas id="chartStatus"></canvas>
    </div>
    <div class="chart-card">
      <div class="chart-card-title"><i class="fas fa-book"></i> Trainings by Technology Area</div>
...
<div class="rpt-section">
  ...
  <div class="chart-row" style="grid-template-columns:1fr">
    <div class="chart-card">
      <div class="chart-card-title"><i class="fas fa-book"></i> Participants per Training</div>
