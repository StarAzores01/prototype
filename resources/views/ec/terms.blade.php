...
<div class="page-header">
  <div class="page-header-left">
    <div class="breadcrumb">PAThrive <i class="fas fa-chevron-right"></i> <span>Terms of Use</span></div>
    <h1>Terms of Use</h1>
...
<div class="card" style="max-width:860px">
  <div class="card-body" style="line-height:1.9;font-size:14px;color:var(--gray-700)">
    ...
    <div style="margin-bottom:24px">
      <div style="font-size:16px;font-weight:700;color:var(--text-heading);margin-bottom:8px">3. Data Accuracy</div>
      <p>Users are responsible for the accuracy of data entered into the system, including activity records, participant information, and evaluation results. Falsification of records is a violation of university policy.</p>
    </div>

    <div style="margin-bottom:24px">
      <div style="font-size:16px;font-weight:700;color:var(--text-heading);margin-bottom:8px">4. Confidentiality</div>
      <p>All data within PAThrive, including participant personal information and activity records, is confidential. Users must not disclose system data to unauthorized parties.</p>
    </div>
    ...
    <div style="margin-bottom:24px">
      <div style="font-size:16px;font-weight:700;color:var(--text-heading);margin-bottom:8px">6. Modifications</div>
    ...
    <div style="margin-top:32px;padding:16px;background:var(--blue-xsoft);border-radius:var(--radius);border:1px solid var(--blue-soft)">
      <p style="font-size:13px;color:var(--navy-mid)"><i class="fas fa-circle-info"></i>For questions regarding these terms, contact the CIT Extension Office at <strong>cit.extension@slsu.edu.ph</strong>.</p>
    </div>
  </div>
</div>
@endsection
