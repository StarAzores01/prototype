...
<div class="page-header">
  ...
  <div style="display:flex;gap:10px">
    ...
    <button class="btn btn-primary" onclick="openModal('editTraining')"><i class="fas fa-pen"></i> Update Training</button>
  </div>
</div>
...
<div class="modal-overlay" id="modal-updateBudget">
  <div class="modal" style="max-width:440px">
    <div class="modal-header">
      <h2><i class="fas fa-sack-dollar"></i> Update Budget</h2>
    ...
    <form method="POST" action="{{ route('ec.trainings.store') }}">
      ...
      <div class="modal-body">
        <div class="alert alert-info" style="margin-bottom:16px;font-size:13px">
          <i class="fas fa-circle-info"></i> Update the allocated budget and the amount currently used for this training.
        </div>
...
<div class="modal-overlay" id="modal-editTraining">
  <div class="modal">
    <div class="modal-header">
      <h2><i class="fas fa-pen"></i>Update Training</h2>
...
<div class="empty-state"><i class="fas fa-book"></i><p>No trainings found. <a href="#" onclick="openModal('addTraining')">Create one.</a></p></div>
@else
<div class="home-grid">
