        ...
        <form method="POST" action="{{ route('evaluator.profile.update') }}">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control field-readonly" value="{{ $evaluator->position }}" readonly/>
            </div>
          </div>
        ...
        <form method="POST" action="{{ route('evaluator.profile.update') }}">
          ...
          <div class="form-group">
            ...
            <div class="pwd-wrap">
              ...
              <span class="pwd-eye" onclick="tp('p1')">&#128065;</span>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group">
              ...
              <div class="pwd-wrap">
                ...
                <span class="pwd-eye" onclick="tp('p2')">&#128065;</span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="pwd-wrap">
                ...
                <span class="pwd-eye" onclick="tp('p3')">&#128065;</span>
              </div>
            </div>
          </div>
  ...
  <div class="dash-side">
    <div class="card">
      <div class="card-body" style="text-align:center;padding:32px 24px">
        ...
        <div style="font-size:18px;font-weight:800;color:var(--navy)">{{ $evaluator->first_name }} {{ $evaluator->last_name }}</div>
        ...
        <div style="margin-top:16px;display:flex;flex-direction:column;gap:10px;text-align:left">
          @foreach([
            ...
            ['fa-building', $evaluator->position ?? '—'],
          ] as [$icon, $val])
