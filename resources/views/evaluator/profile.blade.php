    ...
    <div class="card">
      <div class="card-body" style="text-align:center;padding:32px 24px">
        @include('partials.profile-avatar', [
          'avatarUrl'   => ($evaluator->avatar ?? null) ? route('files.avatar') : null,
          'initials'    => $initials,
          'uploadRoute' => route('evaluator.profile.update'),
          'colorClass'  => 'evaluator',
        ])
        <div style="font-size:18px;font-weight:800;color:var(--text-heading);margin-top:8px">{{ $evaluator->first_name }} {{ $evaluator->last_name }}</div>
