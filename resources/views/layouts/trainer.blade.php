...
$nav = [
    ...
    'trainings'    => ['icon' => 'fa-book',         'label' => 'My Trainings'],
...
<head>
  ...
  <title>PAThrive – {{ ucfirst($activePage) }} (Project Leader)</title>
...
<aside class="sidebar">
  <div class="sidebar-section">
    ...
    @foreach(['dashboard','trainings'] as $key)
  ...
  <div class="sidebar-section">
    ...
    @foreach(['evaluations','skills','activity'] as $key)
    <a href="{{ route('trainer.' . $key) }}" class="sidebar-item {{ $activePage === $key ? 'active' : '' }}">
      <span><i class="fas {{ $nav[$key]['icon'] }}"></i></span><span>{{ $nav[$key]['label'] }}</span>
    </a>
    @endforeach
