...
<nav class="lp-nav" id="lpNav">
  <div class="lp-nav-inner">
    ...
    <div class="lp-nav-actions">
      <a href="{{ route('login') }}"       class="lp-btn-login"><i class="fas fa-arrow-right"></i> Log In</a>
      <a href="{{ route('choose-role') }}" class="lp-btn-signup"><i class="fas fa-plus"></i> Sign Up</a>
    </div>
  </div>
</nav>
