...
@if($loggedIn)
  <div class="{{ $navPrefix }}nav-actions">
    <span style="font-size:13px;font-weight:600;color:rgba(255,255,255,.85);display:inline-flex;align-items:center;gap:6px;flex-wrap:nowrap;max-width:100%;min-width:0">
