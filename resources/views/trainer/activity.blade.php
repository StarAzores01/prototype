...
<div class="card">
  <div class="card-body" style="text-align:center;padding:60px 24px">
    ...
    <div style="font-size:15px;font-weight:700;color:var(--text-heading);margin:12px 0 6px">Select a training to generate the report</div>
...
<div class="card" style="margin-bottom:20px">
  <div class="card-body" style="text-align:center;padding:28px">
    ...
    <div style="font-size:22px;font-weight:800;color:var(--text-heading);margin-bottom:4px">Training Activity Report</div>
