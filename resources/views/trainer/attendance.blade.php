...
<div class="card">
  <div class="card-body" style="text-align:center;padding:60px 24px">
    ...
    <div style="font-size:15px;font-weight:700;color:var(--text-heading);margin:12px 0 6px">Select an activity to begin</div>
...
<div class="card">
  <div class="card-body" style="text-align:center;padding:60px 24px">
    ...
    <p style="font-size:13px;color:var(--gray-400)">Add participants to this activity first.</p>
  </div>
</div>
