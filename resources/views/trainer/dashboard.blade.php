...
<div class="page-header">
  ...
  <a href="{{ route('trainer.documents') }}" class="btn btn-primary">&#8679; Upload Document</a>
</div>
    ...
    <table>
      ...
      @forelse($myTrainings as $t)
        ...
        <tr>
          ...
          <td><a href="{{ route('trainer.trainings') }}?view={{ $t->id }}" class="btn btn-sm btn-outline">&#128065; View</a></td>
        </tr>
      @empty
