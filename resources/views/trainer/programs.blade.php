...
<div class="alert alert-info" style="margin-bottom:20px">
  <i class="fas fa-circle-info"></i> You're a team member on this program, not the Project Lead — you can view everything here and add activities/documents, but only the Project Lead can request a timeline amendment, change status, or manage the team.
</div>
@endif
  ...
  <div class="dash-side">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <span title="Locked — Budget is permanently fixed; the Project Lead can use Request Unlock &amp; Amend to change the timeline" style="color:var(--gray-400)"><i class="fas fa-lock"></i></span>
      </div>
    ...
    <!-- Documents: this Program's own repository, scoped via program_id — lead or member may both upload -->
    <div class="card">
      <div class="card-header">
