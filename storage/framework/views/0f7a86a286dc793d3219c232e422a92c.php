...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .hamburger{display:none;flex-direction:column;justify-content:center;align-items:center;gap:5px;width:40px;height:40px;border-radius:8px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.15);cursor:pointer;flex-shrink:0}
    ...
    .card-img-photo{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block}
  ...
  <div class="nav-inner">
    ...
    <div class="nav-collapse" id="navCollapse">
      <div class="nav-links">
        ...
        <a href="<?php echo e(route('trainings-public')); ?>" class="nav-link active">Trainings</a>
...
<div class="hero">
  <div style="max-width:680px;margin:0 auto;padding:0 24px">
    <div class="eyebrow"><?php echo e(\App\Models\PageContent::get('trainings-public', 'hero_eyebrow', 'Extension Trainings')); ?></div>
    <h1 style="font-size:clamp(28px,4vw,44px);font-weight:800;color:#fff;margin-bottom:16px;line-height:1.2">
      <?php echo e(\App\Models\PageContent::get('trainings-public', 'hero_heading', 'Training Programs')); ?>

    </h1>
    <p style="font-size:15px;color:rgba(255,255,255,.65);line-height:1.7">
      <?php echo e(\App\Models\PageContent::get('trainings-public', 'hero_desc', 'Browse current and upcoming extension training activities conducted by the College of Industrial Technology, SLSU.')); ?>
...
<section style="padding:60px 0 80px">
  <div class="container">
    ...
    <div class="grid" id="trainGrid">
      ...
      ?>
      <div class="card" data-status="<?php echo e($p['status']); ?>">
        <div class="card-img" style="background:<?php echo e($grad); ?>">
          <div class="card-cat"><?php echo e($p['cat']); ?></div>
          <?php if($catImg): ?>
            <img src="<?php echo e($catImg); ?>" alt="<?php echo e($p['cat']); ?>" class="card-img-photo"/>
          <?php else: ?>
            <div class="card-em"><i class="fas <?php echo e($p['emoji']); ?>" style="color:#fff"></i></div>
          <?php endif; ?>
        </div>
        <div class="card-body">
          <div class="card-title"><?php echo e($p['title']); ?></div>
          <div class="card-desc"><?php echo e($p['desc']); ?></div>
          <div class="card-meta">
            <div class="meta-item"><i class="fas fa-calendar"></i> <?php echo e($p['date']); ?></div>
            <div class="meta-item"><i class="fas fa-user"></i> <?php echo e($p['trainer']); ?></div>
          </div>
          <div class="card-foot">
            <span class="badge <?php echo e($badgeClass); ?>"><?php echo e($p['status']); ?></span>
            <a href="<?php echo e(route('choose-role')); ?>" class="card-link">Learn More <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
...
<?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/public/trainings-public.blade.php ENDPATH**/ ?>