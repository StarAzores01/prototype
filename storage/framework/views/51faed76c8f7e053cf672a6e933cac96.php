...
<div style="max-width:760px;margin:0 auto">
  ...
  <div style="text-align:center;margin-bottom:32px">
    <div class="brand-logo" style="margin:0 auto 14px;width:56px;height:56px">
      <img src="<?php echo e(\App\Models\PageContent::get('global', 'site_logo', asset('imgs/logofinalpt.png'))); ?>" alt="CIT" style="width:52px;height:52px;object-fit:contain" onerror="this.style.display='none'"/>
    </div>
    <h1 style="font-size:26px;font-weight:800;color:var(--navy)"><?php echo e(\App\Models\PageContent::get('privacy', 'page_heading', 'Privacy Policy')); ?></h1>
    <p style="color:var(--gray-400);font-size:13px;margin-top:4px">PAThrive &middot; College of Industrial Technology &middot; Last updated: <?php echo e(now()->format('F Y')); ?></p>
  </div>
      ...
      <?php
        $privacyBodyDefault = <<<'HTML'
          ...
          <div>
            ...
            <p>Collected data is used solely for managing College of Industrial Technology extension training programs, generating reports for CHED compliance, and tracking beneficiary outcomes. Data is not shared with third parties.</p>
          </div>
          <div>
          ...
          HTML;
      ?>
      <?php echo \App\Models\PageContent::get('privacy', 'body_html', $privacyBodyDefault); ?>

    </div>
  </div>

  <div style="text-align:center;margin-top:24px;font-size:13px;color:var(--gray-400)">
    <a href="<?php echo e(route('terms')); ?>" style="color:var(--blue-primary)">Terms of Use</a> &middot;
    <a href="<?php echo e(route('home')); ?>" id="goBackLink" style="color:var(--blue-primary)"><i class="fas fa-arrow-left"></i> Go Back</a>
  </div>
</div>
<?php echo $__env->make('public.partials.smart-back-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
<?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/public/privacy.blade.php ENDPATH**/ ?>