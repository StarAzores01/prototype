...
<div class="auth-card" style="max-width:540px">
  <div class="auth-card-header">
    <a href="<?php echo e(route('choose-role')); ?>" style="display:inline-flex;align-items:center;gap:6px;font-size:12.5px;color:#fff;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.3);padding:6px 14px;border-radius:20px;margin-bottom:16px;text-decoration:none">
  ...
  <div class="auth-card-body">
    ...
    <form method="POST" action="<?php echo e(route('beneficiary.signup')); ?>" novalidate>
      <?php echo csrf_field(); ?>

      <div class="form-row">
        <div class="form-group">
          <label class="form-label">First Name *</label>
          <input type="text" name="first_name" class="form-control" value="<?php echo e(old('first_name')); ?>" placeholder="Juan" required/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" name="last_name" class="form-control" value="<?php echo e(old('last_name')); ?>" placeholder="Dela Cruz" required/>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        ...
        <input type="text" name="username" class="form-control" value="<?php echo e(old('username')); ?>" placeholder="juandelacruz" required/>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        ...
        <input type="text" name="id_number" class="form-control" value="<?php echo e(old('id_number')); ?>" placeholder="e.g. 2024-00001" required/>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        ...
        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="juan@email.com" required/>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        ...
        <input type="text" name="phone" class="form-control" value="<?php echo e(old('phone')); ?>" placeholder="0912 345 6789" maxlength="13" oninput="fmtPhone(this)"/>
      </div>

      <div class="form-group">
        <label class="form-label">Address</label>
        <input type="text" name="address" class="form-control" value="<?php echo e(old('address')); ?>" placeholder="Brgy. San Antonio, Lucban, Quezon"/>
      </div>

      <div class="form-row">
        <div class="form-group">
          <label class="form-label">Age</label>
          <input type="number" name="age" class="form-control" value="<?php echo e(old('age')); ?>" placeholder="25" min="1" max="120"/>
        </div>
        <div class="form-group">
          <label class="form-label">Sex</label>
          <select name="sex" class="form-control">
            <option value="">— Select —</option>
            <?php $__currentLoopData = ['Male','Female','Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($s); ?>" <?php echo e(old('sex') === $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group" style="display:flex;align-items:flex-start;gap:10px">
        <input type="checkbox" name="agree" value="1" id="agree" <?php echo e(old('agree') ? 'checked' : ''); ?> required style="margin-top:3px;width:16px;height:16px;flex-shrink:0"/>
        <label for="agree" style="font-size:12.5px;color:var(--gray-600);cursor:pointer">
          I agree to the <a href="<?php echo e(route('terms')); ?>" style="color:var(--blue-primary);font-weight:600">Terms of Use</a> and <a href="<?php echo e(route('privacy')); ?>" style="color:var(--blue-primary);font-weight:600">Privacy Policy</a>.
        </label>
      </div>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="form-error" style="margin-top:-10px;margin-bottom:12px"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/auth/beneficiary-signup.blade.php ENDPATH**/ ?>