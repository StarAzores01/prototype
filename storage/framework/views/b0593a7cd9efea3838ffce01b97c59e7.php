...
<div class="page">
  ...
  <div class="brand">
    <img src="<?php echo e(\App\Models\PageContent::get('global', 'site_logo', asset('imgs/logofinalpt.png'))); ?>" alt="CIT" style="width:44px;height:44px;object-fit:contain" onerror="this.style.display='none'"/>
    <div>
  ...
  <h1><?php echo e(\App\Models\PageContent::get('choose-role', 'heading', 'Create Your Account')); ?></h1>
  <p class="sub"><?php echo e(\App\Models\PageContent::get('choose-role', 'subheading', 'Choose your role to get started')); ?></p>

  <div class="cards">

    <a href="<?php echo e(route('trainer.signup')); ?>" class="card">
    ...
    <a href="<?php echo e(route('beneficiary.signup')); ?>" class="card">
    ...
    <a href="<?php echo e(route('evaluator.signup')); ?>" class="card">
  ...
  <div class="footer-links">
    <?php if($loggedIn): ?>
      Logged in as <?php echo e($userName); ?>? <a href="<?php echo e($dashboardUrl); ?>">Go to your dashboard</a>
    <?php else: ?>
      Already have an account? <a href="<?php echo e(route('login')); ?>">Log in here</a>
    <?php endif; ?>
  </div>
  <a href="<?php echo e(route('home')); ?>" class="back-btn"><i class="fas fa-arrow-left"></i> Back to Home</a>

</div>
</body>
</html>
<?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/public/choose-role.blade.php ENDPATH**/ ?>