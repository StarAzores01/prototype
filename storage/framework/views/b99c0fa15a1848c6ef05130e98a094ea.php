...
<div class="auth-card">
  <div class="auth-card-header">
    <a href="<?php echo e(route('login')); ?>" style="display:inline-flex;align-items:center;gap:6px;font-size:12.5px;color:#fff;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.3);padding:6px 14px;border-radius:20px;margin-bottom:16px;text-decoration:none">
      <i class="fas fa-arrow-left"></i> Back to Login
    </a>
    <div class="brand-logo" style="margin:0 auto 14px">
      <img src="<?php echo e(\App\Models\PageContent::get('global', 'site_logo', asset('imgs/logofinalpt.png'))); ?>" alt="CIT" style="width:44px;height:44px;object-fit:contain" onerror="this.style.display='none';this.parentElement.textContent='PA'"/>
    </div>
    <h1><?php echo e($step === 'reset' ? 'Set New Password' : 'Account Recovery'); ?></h1>
    <p><?php echo e($step === 'reset' ? 'Enter your new password below' : "We'll help you get back in"); ?></p>
  </div>

  <div class="auth-card-body">
    <?php if(session('error')): ?><div class="alert alert-danger"><i class="fas fa-triangle-exclamation"></i> <?php echo e(session('error')); ?></div><?php endif; ?>
    <?php if($errors->any()): ?><div class="alert alert-danger"><i class="fas fa-triangle-exclamation"></i> <?php echo e($errors->first()); ?></div><?php endif; ?>
    <?php if(session('success')): ?><div class="alert alert-success"><i class="fas fa-square-check"></i> <?php echo session('success'); ?></div><?php endif; ?>

    <?php if($step === 'request' && !session('success')): ?>
    ...
    <form method="POST" action="<?php echo e(route('ec.recovery')); ?>">
      <?php echo csrf_field(); ?>
  ...
  <div class="auth-footer">
    Remembered your password? <a href="<?php echo e(route('login')); ?>">Log in here</a>
  </div>
</div>
...
<?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/auth/ec-recovery.blade.php ENDPATH**/ ?>