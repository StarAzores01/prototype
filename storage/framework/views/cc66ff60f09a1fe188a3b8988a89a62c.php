...
<div class="inner-tab-panel active" id="tab-pages">
  <div class="home-grid">
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$routeName, $title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="training-card">
      <div class="training-card-body">
        <div class="training-card-title"><?php echo e($title); ?></div>
        <div class="training-card-desc"><?php echo e($desc); ?></div>
        <div class="training-card-footer">
          <button type="button" class="btn btn-sm btn-outline" onclick="openPagePreview('<?php echo e($routeName); ?>')">
            <i class="fas fa-eye"></i> View Live
          </button>
          <button type="button" class="btn btn-sm btn-primary" onclick="openModal('edit-<?php echo e($routeName); ?>')">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="tc-img-cell">
            <?php if($cat->image): ?>
              <img src="<?php echo e($cat->image); ?>" alt="<?php echo e($cat->activity_name); ?>" style="width:44px;height:34px;border-radius:6px;object-fit:cover;display:block"/>
            <?php else: ?>
          ...
          <td class="tc-name-cell"><strong><?php echo e($cat->activity_name); ?></strong></td>
          
          <td class="tc-desc-cell" style="color:var(--gray-500);max-width:260px"><?php echo e(\Illuminate\Support\Str::limit($cat->description, 90)); ?></td>
          
          <td class="tc-meta-cell" style="white-space:nowrap"><?php echo e($cat->programName()); ?></td>
          <td class="tc-meta-cell"><span class="badge <?php echo e($cat->status === 'active' ? 'badge-active' : 'badge-pending'); ?>"><?php echo e(ucfirst($cat->status)); ?></span></td>
          
          <td class="tc-actions-cell">
            <div class="action-btns">
              <button type="button" class="btn btn-sm btn-outline" onclick="openEditCategoryModal(<?php echo e($cat->toJson()); ?>)" title="Edit"><i class="fas fa-pen"></i></button>
              <button type="button" class="btn btn-sm btn-outline" onclick="openChangeImageModal(<?php echo e($cat->id); ?>, <?php echo e(Illuminate\Support\Js::from($cat->activity_name)); ?>)" title="Change Image"><i class="fas fa-camera"></i></button>
              <form method="POST" action="<?php echo e(route('ec.page-content.trainings.store')); ?>" style="display:inline" onsubmit="return confirm('Delete &quot;<?php echo e($cat->activity_name); ?>&quot;? This will remove it from the public website.')">
                <?php echo csrf_field(); ?>
...
<div class="inner-tab-panel" id="tab-settings">
  ...
  <div class="settings-subpanel" id="set-branding" style="display:block">
    <div class="card">
      ...
      <form method="POST" action="<?php echo e(route('ec.page-content.update')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card-body">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'site_tagline','label'=>'Tagline (shown under the logo)','type'=>'text','rows'=>1,'fieldValue'=>$v('global','site_tagline')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'footer_tagline','label'=>'Site Description','type'=>'text','fieldValue'=>$v('global','footer_tagline')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'site_logo','label'=>'Logo','type'=>'image','fieldValue'=>$v('global','site_logo')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
  ...
  <div class="settings-subpanel" id="set-footer" style="display:none">
    <div class="card">
      ...
      <form method="POST" action="<?php echo e(route('ec.page-content.update')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card-body">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'footer_tagline','label'=>'Footer Description','type'=>'text','fieldValue'=>$v('global','footer_tagline')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <div class="form-row">
            <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'contact_address','label'=>'Address','type'=>'text','rows'=>2,'fieldValue'=>$v('global','contact_address')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'contact_email','label'=>'Email','type'=>'text','rows'=>1,'fieldValue'=>$v('global','contact_email')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          </div>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'contact_phone','label'=>'Phone','type'=>'text','rows'=>1,'fieldValue'=>$v('global','contact_phone')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'footer_copyright','label'=>'Copyright Text','type'=>'text','rows'=>1,'hint'=>'Leave blank to use the default "© '.now()->year.' PAThrive – SLSU College of Industrial Technology. All rights reserved."','fieldValue'=>$v('global','footer_copyright')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div class="modal-footer" style="border-top:1px solid var(--gray-100)">
...
<div class="modal-overlay" id="modal-edit-home">
  <div class="modal" style="max-width:640px">
    ...
    <div class="modal-body">
      ...
      <form id="homeContentForm" method="POST" action="<?php echo e(route('ec.page-content.update')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div id="home-hero" class="home-subpanel" style="display:block">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'hero_badge','label'=>'Hero Eyebrow Badge','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','hero_badge')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'hero_heading_text','label'=>'Main Headline','type'=>'text','rows'=>2,'fieldValue'=>$v('landing','hero_heading_text')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'hero_heading_highlight','label'=>'Highlighted Word(s) (shown in blue)','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','hero_heading_highlight')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'hero_subheading','label'=>'Description','type'=>'text','fieldValue'=>$v('landing','hero_subheading')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'hero_image','label'=>'Hero Background Image','type'=>'image','fieldValue'=>$v('landing','hero_image')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div id="home-intro" class="home-subpanel" style="display:none">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'courses_badge','label'=>'Section Label','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','courses_badge')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'courses_title','label'=>'Section Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','courses_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'courses_desc','label'=>'Description','type'=>'text','fieldValue'=>$v('landing','courses_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div id="home-courses" class="home-subpanel" style="display:none">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'programs_badge','label'=>'Section Label','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','programs_badge')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'programs_title','label'=>'Section Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','programs_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'programs_desc','label'=>'Description','type'=>'text','fieldValue'=>$v('landing','programs_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div id="home-cta" class="home-subpanel" style="display:none">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'cta_heading','label'=>'Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','cta_heading')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'cta_desc','label'=>'Description','type'=>'text','fieldValue'=>$v('landing','cta_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'landing','key'=>'cta_button_text','label'=>'Button Text','type'=>'text','rows'=>1,'fieldValue'=>$v('landing','cta_button_text')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
      </form>
      ...
      <div id="home-video" class="home-subpanel" style="display:none">
        ...
        <form method="POST" action="<?php echo e(route('ec.dashboard.store')); ?>">
          ...
          <div class="form-group">
            ...
            <input type="text" name="video_title" class="form-control" value="<?php echo e(old('video_title', $homepageVideo?->video_title)); ?>" placeholder="e.g. SLSU March"/>
          </div>
          <div class="form-group">
            <label class="form-label">Video Link</label>
            <input type="url" name="video_url" class="form-control" value="<?php echo e(old('video_url', $homepageVideo?->video_url)); ?>" placeholder="https://..."/>
    ...
    <form method="POST" action="<?php echo e(route('ec.page-content.update')); ?>" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <div id="ab-hero" class="about-subpanel" style="display:block">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'hero_eyebrow','label'=>'Pill Label','type'=>'text','rows'=>1,'fieldValue'=>$v('about','hero_eyebrow')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'hero_heading','label'=>'Page Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('about','hero_heading')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'hero_desc','label'=>'Description','type'=>'text','fieldValue'=>$v('about','hero_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div id="ab-system" class="about-subpanel" style="display:none">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'system_badge','label'=>'Section Label','type'=>'text','rows'=>1,'fieldValue'=>$v('about','system_badge')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'system_title','label'=>'Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('about','system_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'system_body','label'=>'Body Text','type'=>'text','rows'=>6,'fieldValue'=>$v('about','system_body')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div id="ab-cit" class="about-subpanel" style="display:none">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'college_badge','label'=>'Section Label','type'=>'text','rows'=>1,'fieldValue'=>$v('about','college_badge')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'college_title','label'=>'Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('about','college_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'college_desc','label'=>'Subheading / Description','type'=>'text','fieldValue'=>$v('about','college_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'college_body','label'=>'Body Text','type'=>'text','rows'=>5,'fieldValue'=>$v('about','college_body')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div id="ab-programs" class="about-subpanel" style="display:none">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'programs_badge','label'=>'Section Label','type'=>'text','rows'=>1,'fieldValue'=>$v('about','programs_badge')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'programs_title','label'=>'Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('about','programs_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'about','key'=>'programs_desc','label'=>'Description','type'=>'text','fieldValue'=>$v('about','programs_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
      </div>
      <div class="modal-footer">
  ...
  <div class="modal">
    ...
    <form method="POST" action="<?php echo e(route('ec.page-content.update')); ?>" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'trainings-public','key'=>'hero_eyebrow','label'=>'Pill Label','type'=>'text','rows'=>1,'fieldValue'=>$v('trainings-public','hero_eyebrow')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'trainings-public','key'=>'hero_heading','label'=>'Page Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('trainings-public','hero_heading')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'trainings-public','key'=>'hero_desc','label'=>'Description','type'=>'text','fieldValue'=>$v('trainings-public','hero_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      </div>
      <div class="modal-footer">
...
<div class="modal-overlay" id="modal-edit-contact">
  <div class="modal" style="max-width:640px">
    ...
    <form method="POST" action="<?php echo e(route('ec.page-content.update')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
      <div class="modal-body">
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'hero_eyebrow','label'=>'Pill Label','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','hero_eyebrow')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'hero_heading','label'=>'Page Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','hero_heading')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'hero_desc','label'=>'Description','type'=>'text','fieldValue'=>$v('contact','hero_desc')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <hr class="divider"/>
        <div class="section-row-title" style="font-size:13px;font-weight:700;margin-bottom:10px">Contact Info Section</div>
        <div class="form-row">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'info_section_title','label'=>'Section Title','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','info_section_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'info_section_sub','label'=>'Section Subtitle','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','info_section_sub')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="form-row">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'global','key'=>'contact_phone','label'=>'Phone','type'=>'text','rows'=>1,'fieldValue'=>$v('global','contact_phone')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'office_hours','label'=>'Office Hours','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','office_hours')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div class="form-row">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'website','label'=>'Website','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','website')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'facebook','label'=>'Facebook','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','facebook')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <hr class="divider"/>
        <div class="section-row-title" style="font-size:13px;font-weight:700;margin-bottom:10px">Contact Form</div>
        <div class="form-row">
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'message_section_title','label'=>'Form Heading','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','message_section_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php echo $__env->make('ec.page-content._field', ['pageKey'=>'contact','key'=>'message_section_sub','label'=>'Form Description','type'=>'text','rows'=>1,'fieldValue'=>$v('contact','message_section_sub')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
      </div>
      <div class="modal-footer">
...
<?php $__currentLoopData = [
  ...
  ['terms',   'Terms of Use'],
]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$legalKey, $legalTitle]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal-overlay" id="modal-edit-<?php echo e($legalKey); ?>">
  <div class="modal">
    <div class="modal-header">
      <h2><i class="fas fa-file-lines"></i> Edit <?php echo e($legalTitle); ?></h2>
      <button class="modal-close" onclick="closeModal('edit-<?php echo e($legalKey); ?>')"><i class="fas fa-xmark"></i></button>
    </div>
    <form method="POST" action="<?php echo e(route('ec.page-content.update')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
      <div class="modal-body">
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>$legalKey,'key'=>'page_heading','label'=>'Page Heading','type'=>'text','rows'=>1,'fieldValue'=>$v($legalKey,'page_heading')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('ec.page-content._field', ['pageKey'=>$legalKey,'key'=>'body_html','label'=>'Content','type'=>'text','rows'=>10,'fieldValue'=>$v($legalKey,'body_html'),'extraClass'=>'policy-body-editor'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline" onclick="closeModal('edit-<?php echo e($legalKey); ?>')">Cancel</button>
        <button type="submit" class="btn btn-primary"><i class="fas fa-check"></i> Save Changes</button>
      </div>
    </form>
  </div>
...
<div class="modal-overlay" id="modal-add-training">
  <div class="modal">
    ...
    <form method="POST" action="<?php echo e(route('ec.page-content.trainings.store')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
...
<div class="modal-overlay" id="modal-edit-training">
  <div class="modal">
    ...
    <form method="POST" action="<?php echo e(route('ec.page-content.trainings.store')); ?>">
      <?php echo csrf_field(); ?>
...
var _pageUrls = {
  ...
  'about':             <?php echo json_encode(route('about'), 15, 512) ?>,
  'trainings-public':  <?php echo json_encode(route('trainings-public'), 15, 512) ?>,
  'contact':           <?php echo json_encode(route('contact'), 15, 512) ?>,
  'privacy':           <?php echo json_encode(route('privacy'), 15, 512) ?>,
  'terms':             <?php echo json_encode(route('terms'), 15, 512) ?>,
};
var _pageUrlLabels = {
  'home':              'pathrive / home',
...
<?php echo $__env->make('layouts.ec', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/ec/page-content/index.blade.php ENDPATH**/ ?>