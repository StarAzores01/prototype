...
<div style="max-width:760px;margin:0 auto">
  ...
  <div style="text-align:center;margin-bottom:32px">
    ...
    <h1 style="font-size:26px;font-weight:800;color:var(--navy)"><?php echo e(\App\Models\PageContent::get('terms', 'page_heading', 'Terms of Use')); ?></h1>
    ...
    <div class="card-body" style="line-height:1.9;font-size:14px;color:var(--gray-700);display:flex;flex-direction:column;gap:24px">
      <?php
        $termsBodyDefault = <<<'HTML'
          ...
          HTML;
      ?>
      <?php echo \App\Models\PageContent::get('terms', 'body_html', $termsBodyDefault); ?>

    </div>
  </div>

  <div style="text-align:center;margin-top:24px;font-size:13px;color:var(--gray-400)">
    <a href="<?php echo e(route('privacy')); ?>" style="color:var(--blue-primary)">Privacy Policy</a> &middot;
...
<?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/public/terms.blade.php ENDPATH**/ ?>