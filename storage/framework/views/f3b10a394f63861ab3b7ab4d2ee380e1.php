...
<body class="auth-body">
  ...
  <div class="auth-card">
    ...
    <div class="auth-card-header">
      <a href="<?php echo e(route('home')); ?>" style="display:inline-flex;align-items:center;gap:6px;font-size:12.5px;color:#fff;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.3);padding:6px 14px;border-radius:20px;margin-bottom:16px;text-decoration:none">
        <i class="fas fa-arrow-left"></i> Back to Home
      </a>
      <div class="brand-logo" style="margin:0 auto 14px">
        <img src="<?php echo e(\App\Models\PageContent::get('global', 'site_logo', asset('imgs/logofinalpt.png'))); ?>" alt="CIT"
    ...
    <div class="auth-card-body">
      ...
      <?php if(session('info')): ?>
      <div class="alert alert-info"><i class="fas fa-circle-info"></i> <?php echo e(session('info')); ?></div>
      <?php endif; ?>
      <?php if(session('error')): ?>
      <div class="alert alert-danger"><i class="fas fa-triangle-exclamation"></i> <?php echo e(session('error')); ?></div>
      <?php endif; ?>
      <?php if($errors->any()): ?>
      <div class="alert alert-danger"><i class="fas fa-triangle-exclamation"></i> <?php echo e($errors->first()); ?></div>
      <?php endif; ?>
      ...
      <form method="POST" action="<?php echo e(route('login')); ?>" novalidate>
        ...
        <a href="<?php echo e(route('ec.recovery')); ?>" class="li-forgot">Forgot password?</a>
    ...
    <div class="auth-footer">
      Don't have an account? <a href="<?php echo e(route('choose-role')); ?>">Sign up here</a>
    </div>
...
<?php /**PATH C:\Users\ELAI\OneDrive\Documents\GitHub\prototype\resources\views/auth/login.blade.php ENDPATH**/ ?>