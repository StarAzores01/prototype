...
<div style="max-width:760px;margin:0 auto">
  ...
  <div style="text-align:center;margin-bottom:32px">
    <div class="brand-logo" style="margin:0 auto 14px;width:56px;height:56px">
      <img src="<?= BASE_URL ?>/imgs/logofinalpt.png" alt="CIT" style="width:52px;height:52px;object-fit:contain" onerror="this.style.display='none'"/>
    </div>
    <h1 style="font-size:26px;font-weight:800;color:var(--navy)">Terms of Use</h1>
    <p style="color:var(--gray-400);font-size:13px;margin-top:4px">PAThrive · CIT-SLSU · Last updated: <?= date('F Y') ?></p>
  </div>
  ...
  <div class="card">
    <div class="card-body" style="line-height:1.9;font-size:14px;color:var(--gray-700);display:flex;flex-direction:column;gap:24px">
      ...
      <div style="padding:16px;background:var(--blue-xsoft);border-radius:var(--radius);border:1px solid var(--blue-soft)">
        <p style="font-size:13px;color:var(--navy-mid)">&#8505; For questions, contact the CIT Extension Office at <strong>cit.extension@slsu.edu.ph</strong>.</p>
      </div>
    </div>
  </div>

  <div style="text-align:center;margin-top:24px;font-size:13px;color:var(--gray-400)">
    <a href="<?= BASE_URL ?>/privacy.php" style="color:var(--blue-primary)">Privacy Policy</a> ·
    <a href="javascript:history.back()" style="color:var(--blue-primary)">&#8592; Go Back</a>
  </div>
</div>
</body>
</html>
