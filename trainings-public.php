...
$programs = [
  ['emoji'=>'🍳','cat'=>'Culinary Technology',           'title'=>'Basic Pastry Making',          'desc'=>'Hands-on baking and pastry workshop covering bread-making, cake decoration, and basic pastry techniques for livelihood development.','date'=>'Mar 10, 2026','venue'=>'Lucban, Quezon',      'trainer'=>'Aurita A. Laguador',   'pax'=>28,'status'=>'Ongoing'],
  ['emoji'=>'🔌','cat'=>'Electronics Technology',        'title'=>'Basic Electronics Servicing',  'desc'=>'Fundamentals of electronics, circuit troubleshooting, and component identification for displaced workers and out-of-school youth.','date'=>'Feb 18, 2026','venue'=>'Tayabas City',       'trainer'=>'Jose D. Sanvictores',  'pax'=>35,'status'=>'Completed'],
  ['emoji'=>'💻','cat'=>'Computer Technology',           'title'=>'Computer Literacy Program',    'desc'=>'MS Office, internet literacy, and digital tools for solo parents and community members seeking employment opportunities.','date'=>'Mar 5, 2026', 'venue'=>'SLSU Main Campus',   'trainer'=>'Reynaldo V. Danganan', 'pax'=>40,'status'=>'Ongoing'],
  ['emoji'=>'🧵','cat'=>'Apparel and Fashion Technology','title'=>'Dressmaking & Sewing Basics',  'desc'=>'Introduction to garment construction, pattern-making, and basic sewing techniques for women beneficiaries and out-of-school youth.','date'=>'Apr 2, 2026', 'venue'=>'Candelaria, Quezon', 'trainer'=>'Maricel O. Lingatong', 'pax'=>25,'status'=>'Upcoming'],
  ['emoji'=>'🖥️','cat'=>'Information Technology',       'title'=>'Web Design Fundamentals',      'desc'=>'HTML, CSS, and basic web design principles for young adults seeking digital livelihood opportunities.','date'=>'Mar 28, 2026','venue'=>'Lucena City',        'trainer'=>'Devie S. Bello',       'pax'=>50,'status'=>'Upcoming'],
  ['emoji'=>'🚗','cat'=>'Automotive Technology',         'title'=>'Basic Automotive Servicing',   'desc'=>'Introduction to vehicle maintenance, engine basics, and automotive safety for displaced workers and youth.','date'=>'May 10, 2026','venue'=>'Mauban, Quezon',     'trainer'=>'Angelito L. Mangubat', 'pax'=>20,'status'=>'Upcoming'],
];
...
<nav class="nav" id="mainNav">
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a href="<?= BASE_URL ?>/trainings-public.php" class="nav-link active">Trainings</a>
    ...
    <div class="grid" id="trainGrid">
      ...
      <div class="card" data-status="<?= $p['status'] ?>">
        <div class="card-img" style="background:<?= $grad ?>">
          <div class="card-cat"><?= htmlspecialchars($p['cat']) ?></div>
          <div class="card-em"><?= $p['emoji'] ?></div>
        </div>
        <div class="card-body">
          <div class="card-title"><?= htmlspecialchars($p['title']) ?></div>
          <div class="card-desc"><?= htmlspecialchars($p['desc']) ?></div>
          <div class="card-meta">
            <div class="meta-item">&#128197; <?= htmlspecialchars($p['date']) ?></div>
        <div class="meta-item">&#128100; <?= htmlspecialchars($p['trainer']) ?></div>
          </div>
          <div class="card-foot">
            <span class="badge <?= $badgeClass ?>"><?= $p['status'] ?></span>
            <a href="<?= BASE_URL ?>/choose-role.php" class="card-link">
              <!-- <?= $p['status'] === 'Completed' ? 'View Report' : 'Register Now' ?> -->
              <!-- &#8594; -->
            </a>
          </div>
        </div>
